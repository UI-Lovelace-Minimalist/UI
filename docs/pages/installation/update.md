...
* Complete  
  ...
  <summary>Where do I have to look and what do I need to copy</summary>  
    ...
    * *Optional* If you want to use `custom-cards`, than you have to do this the same way as above.  
    ...
    * Copy the complete code and open your raw-config-editor in Lovelace for the "Minimalist" dashboard. Select the whole block of code, that you inserted during installation. It should start with the line `button_card_templates:` and should end with `views:`.  
