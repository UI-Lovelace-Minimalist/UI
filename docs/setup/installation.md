...
Then you can follow the step ["Install Integrations"](https://ui-lovelace-minimalist.github.io/UI/setup/installation/#install-integrations) from the HACS installation.
