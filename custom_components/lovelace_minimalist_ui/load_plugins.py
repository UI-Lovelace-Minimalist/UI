...
def load_plugins(hass: HomeAssistant, lmu: LmuBase):
    ...
    if lmu.configuration.include_other_cards:
        # # Cards by others
        add_extra_js_url(
            hass, "/lovelace_minimalist_ui/card_resources/button-card/button-card.js"
        )
        add_extra_js_url(
            hass, "/lovelace_minimalist_ui/card_resources/lovelace-card-mod/card-mod.js"
        )
        add_extra_js_url(
            hass,
            "/lovelace_minimalist_ui/card_resources/lovelace-card-mod/rollup.config.js",
        )
        add_extra_js_url(
            hass,
            "/lovelace_minimalist_ui/card_resources/mini-graph-card/mini-graph-card-bundle.js",
        )
        add_extra_js_url(
            hass,
            "/lovelace_minimalist_ui/card_resources/mini-media-player/mini-media-player-bundle.js",
        )
        # https://github.com/AnthonMS/my-cards/blob/989034979aa885efb7ee8ae2ff05c46f7748b05c/dist/my-cards.js
        add_extra_js_url(
            hass,
            "/lovelace_minimalist_ui/card_resources/my-cards-slider-card/my-cards.js",
        )
        add_extra_js_url(
            hass,
            "/lovelace_minimalist_ui/card_resources/light-entity-card/light-entity-card.js",
        )
    ...
    hass.http.register_static_path(
        "/lovelace_minimalist_ui/js",
        hass.config.path(f"custom_components/{DOMAIN}/js"),
        True,
    )
    hass.http.register_static_path(
        "/lovelace_minimalist_ui/card_resources",
